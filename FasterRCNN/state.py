...
class BestWeightsTracker:
  ...
  def save_best_weights(self, model, epoch):    
    t.save(self._best_state, self._filepath + "_" + str(epoch))
    print("Saved model weights to " + self._filepath + "_" + str(epoch))
 
  def print_best_weights(self):
    print()
    print(37 * '-')
    print("File number with the best weights:", self._best_epoch)
    print(37 * '-')
